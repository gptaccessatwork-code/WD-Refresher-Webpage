...
# SVG <text> node with the exact attributes Oracle uses for the Items label
# inside each expanded Kitting panel:
#   <text dominant-baseline="text-before-edge" fill="#666666"
#         font-family="arial" font-size="13px" font-weight="bold">Items</text>
# We count occurrences: 1 = normal, >1 = over-assigned / duplicated → flag.
_ITEMS_BOLD_TEXT_XPATH = (
    "//*[name()='text']"
...
def verify_assignment(driver, item_number: str) -> Optional[str]:
    ...
    items_nodes = driver.find_elements(By.XPATH, _ITEMS_BOLD_TEXT_XPATH)
